...
print(" - Plotting trace to out/test_trace_plot.eps")
sensors_trace.plot_trace("out/test_trace_plot.eps")

print(" - Saving trace to out/test_trace.txt")
sensors_trace.save_trace("out/test_trace.txt")

print(" - Loading trace from out/test_trace.txt")
file_sensors_trace = Trace(load_file = "out/test_trace.txt")
