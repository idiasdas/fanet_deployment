...
class Graph:
    def __init__(self, size_A, heights, base_station, n_drones, n_positions_per_axis, observation_period, communication_range, coverage_range, targets_trace = []):
        ...
        Args:
            ...
            communication_range (float): Maximum distance for communications drone to drone and base to drone 
            coverage_range (float): Maximum distance for communications drone to target
    ...
    def get_target_coverage(self, target_position):
    ...
    def get_positions_in_comm_range(self, position):
